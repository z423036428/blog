...
<html>
	<head>
		...
		<link href="<%=path %>/css/admin/layout.css" rel="stylesheet" type="text/css">
		...
		<script type="text/javascript" src="<%=path %>/js/admin/js.js"></script>
	</head>
	<style>
		.ibar {display: none;}
	</style>
		...
		<div class="main ">
			...
			<div class="login-dom login-max">
				<div class="logo text-center">
					<a href="#">
					<img src="<%=path %>/img/admin/logo.png" width="180px" height="180px">
					</a>
				</div>
				<div class="login container " id="login">
					...
					<form class="login-form" action="<%=path %>/user/login.action" method="post" autocomplete="off">
	...
	<script type="text/javascript" src="<%=path %>/js/admin/Validform_v5.3.2_min.js"></script>
